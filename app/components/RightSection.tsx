  ...
  return (
    <div className="w-full relative p-4 md:p-5 lg:p-8 border-[0.2px] border-white/10 rounded-3xl bg-[#1e1e1f]">
      ...
      <div className="hidden lg:block">
        <div className="absolute w-lg text-lg flex justify-around top-0 right-0 border-[0.2px] border-white/10 bg-[#282829] rounded-tr-3xl *:hover:text-yellow-200 *:transition-none rounded-bl-3xl px-8 py-4">
          {buttons.map((buttonval, index) => (
            <button
