...
export default function RightSection() {
  ...
  border text-xs
 md:text-lg justify-between items-center px-10 sm:px-20 py-5"
        >
      ...
      <div className="hidden lg:block">
        <div className="absolute w-lg text-lg flex justify-around top-0 right-0 border-[0.2px] border-white/10 bg-[#282829] rounded-tr-3xl *:hover:text-yellow-200 *:cursor-pointer rounded-bl-3xl px-8 py-4 ">
          {buttons.map((buttonval, index) => {
            return (
              <button
                className={`${buttonval === currentPage && "text-yellow-200"} select-none`}
